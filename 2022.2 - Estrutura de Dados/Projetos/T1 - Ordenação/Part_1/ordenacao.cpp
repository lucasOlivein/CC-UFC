...
int *Sort::alocar(int *list, int length)
{
    list_ord = new int[length];
    aux_len = length;
...
Bubble::Bubble(int *list_, int length_)
{
    list = list_;
    length = length_;
    num_comp = 0;
...
Insetion::Insetion(int *list_, int length_)
{
    list = list_;
    length = length_;
    num_comp = 0;
...
Selection::Selection(int *list_, int length_)
{
    list = list_;
    length = length_;
    num_comp = 0;
...
void Selection::recursivo_op2() /// DIficuldades: nao conseguir alterar o valor de length para as prox interacao recursiva
...
Quick::Quick(int *list_, int length_)
{
    list = list_;
    length = length_;
    i = new Index[924370];
...
{
    _interativo(0, length);
}
void Quick::_interativo(int inicio, int length)
{
    int inter_atual = 0;
    int inter_final = 0;
...
void Quick::interativo(int inicio, int length)
{
    int inter_atual = 0;
    int inter_final = 0;
...
void Quick::interativo_op2()
{
    ...
    interativo(0, p);
    _interativo(p, length);
}

void Quick::recursivo()
{
    recursivo(0, length - 1);
}
...
Merge::Merge(int list[], int length)
{
    this->list = list;
...
void Merge::interativo(int start, int length)
{
    int inicio;
    int fim;
    int bloco = 1;
...
void Merge::_interativo(int start, int length)
{
    int inicio;
    // cout << "Start: " << inicio << "\n";
    int fim;
