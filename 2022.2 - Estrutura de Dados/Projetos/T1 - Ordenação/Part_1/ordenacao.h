...
public:
    ...
    int comparacoes;
    double exec_temp;
    int *alocar(int *list, int length);
    ~Sort();
...
public:
    Insetion(int *list_, int length_);
...
public:
    Selection(int *list_, int length_);
    int select(int i);
    void interativo();
    void recursivo();
...
public:
    Quick(int *list_, int length_);
    ~Quick();
    int _partition(int inicio, int fim);
    void _interativo();
    void _interativo(int inicio, int length);

    int partition(int inicio, int fim);

    void interativo();
    void interativo(int inicio, int length);
...
public:
    ...
    void interativo();
    void interativo(int start, int length);

    void _interativo(int start, int length);
